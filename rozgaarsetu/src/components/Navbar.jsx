...
const Navbar = () => {
  return (
    <div className='w-full p-8 flex justify-between items-center'>
        ...
        <div className=''>
            <button className='bg-button-bg text-primary-white px-6 py-2 rounded-lg hover:bg-gradient-dark transition duration-300 ease-in-out text-xl tracking-tighter'>
                Download Our App
            </button>
        </div>
    </div>
